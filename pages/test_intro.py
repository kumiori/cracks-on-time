...
def nucleate(survey):
    name = survey.text_input("`Nice to meet you, how should we call you?`")
    """
...
fields_forge = {
    "Form name": "I agree to join my viewpoints",
    "Email": "Email",
    "Username": "Username",
    "Password": "Password",
    "Repeat password": "Repeat password",
...
"""
    ...
    if pages.current == 1:
        ...
        question = survey.text_input("My viewpoint:", id="question")
        hash_question = hash(question)
        """
        An open-ended question, a moment of reflection on motivations, insights, and the significance of one's work in the larger context of glaciology."""

    if pages.current == 2:
        st.title("We are mapping an energy process.")
        st.markdown(
            """
            Cracks in ice systems show the interplay between energy accumulation, release, and dissipation, shaping their evolution... 
            ## But _when_ is the next big crack?
            
            Energy-based approaches may offer a powerful lens to analyse these processes, quantifying stability transitions, from damage accumulation to crack nucleation and propagation. 
    ...
    if pages.current == 3:
        """
            ### Energy accumulates and cracks release. 
            ...
            ## But _where_ are new cracks nucleating?
        """
...
"""
        ...
        """
        # _Submit your viewpoints_ to create an interactive and collaborative platform to map knowledge and bridge its gaps, foster interdisciplinary connections, and deepen our understanding of ice behaviour.
